...
We call the resulting multi-output Gaussian process a [Hidden Physics Model](https://arxiv.org/abs/1708.00588), because its matrix of covariance functions explicitly encodes the underlying laws of physics expressed by the corresponding partial differential equation.
...
<div class="img_row">
    <img class="col three" src="{{ site.url }}/assets/img/NavierStokes.png" alt="" title="example image"/>
</div>
<div class="col three caption">
...
<div class="img_row">
    <img class="col three" src="{{ site.url }}/assets/img/Fractional_Levy.png" alt="" title="example image"/>
</div>
